...
class TC02_LoginTest extends TestBase{
	
	public static final Logger log = Logger.getLogger(TC02_LoginTest.class.getName());
    ...
    @Test
	 void loginTest02() {
		   ...
		   login = new LoginPage(driver); // login page class instantiation
		   ...
		   login_cred=excel.getCellData(filepath,"loginData.xlsx", "login",row_num);
			...
			screen.getScreenShot(driver, "Test_02_FailedLogin");
